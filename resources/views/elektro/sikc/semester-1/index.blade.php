...
<div class="container px-4 px-lg-5">
    <section class="content">
        <h3>RPS Program Studi Sistem Informasi Kota Cerdas - Semester 1</h3>
        Tahun Ajaran 2023
        <div class="container">
            <table class="table">
              <thead class="thead-z">
                <tr>
                  ...
                  <th scope="col">Keterangan</th> <!-- Tambahkan kolom "Keterangan" di sini -->
                </tr>
              </thead>
              <tbody>
                @foreach ($rps as $item)
                @if (($item->prodi_id == 11) && ($item->semester_id == 1))
                  <tr>
